...
const MEAL_SHAPE = `{"photo_text":[{"photo":1,"text":""}],"items":[{"photos":[1],"brand":"","name":"","barcode":"","from_label":false,"servings":0,"portion":"","grams":0,"kcal":0,"protein_g":0,"carbs_g":0,"fat_g":0,"confidence":0.0}],"notes":"","name":"","scale_read":false}`;
