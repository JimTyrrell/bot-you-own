...
**Bonus, for coaches: a photo food log.** `/track` is a camera-first food log your
...
every client at `/track/coach`. On by default; `docs/FOOD-LOG.md` has the whole thing.
