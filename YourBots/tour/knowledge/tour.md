...
own Cloudflare account. It runs from public code (github.com/JimTyrrell/bot-you-own).
...
Everything is in the public repo: the prompt pieces (YourBots/_prompt), each
